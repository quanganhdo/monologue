/*
	jQuery Plugin spy (leftlogic.com/info/articles/jquery_spy2) - Modified by QAD
...
$.fn.spy = function(settings) {
	...
	spy.addItem = function(e, i) {
		if (! o.isDupe.call(this, i, spy.last)) {
			...
			$('#' + e.id + ' > li:gt(' + (o.limit - 2) + ')').remove();
			$('#' + e.id + ' > li:gt(' + (o.limit - o.fadeLast - 2) + ')').fadeEachDown();
			o.push.call(e, i);
			$('#' + e.id + ' > li:first').fadeIn(o.fadeInSpeed);
		}
	}
